...
-- Дата скрипта: 15.01.2020 19:56:33
...
FROM (`booking_list`
  LEFT JOIN `living_list`
    ON ((`booking_list`.`IDc` = `living_list`.`IDc`)))
...
(55, '867414873', '1574405400d459218087f844a3fe96dc', 'a7495ef7802b421416b00e39d76a7672', 1),
...
(12, 2, 32, 420, 7, 0, 420, '2020-01-12 00:00:00');
...
(53, 55, 18, '2020-01-09 20:59:55', '2020-01-09 00:00:00', '2020-03-08 00:00:00', 1),
