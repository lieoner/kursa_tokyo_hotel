...
-- Дата скрипта: 07.02.2020 1:12:22
...
--
-- Удалить представление `human_view_total_cost`
--
DROP VIEW IF EXISTS human_view_total_cost CASCADE;
...
--
-- Удалить представление `total_service_cost`
--
DROP VIEW IF EXISTS total_service_cost CASCADE;
...
--
-- Создать представление `total_service_cost`
--
CREATE
DEFINER = 'root'@'%'
VIEW total_service_cost
AS
SELECT
  `human_view_service_queries`.`IDc` AS `IDc`,
  SUM(`human_view_service_queries`.`totalCost`) AS `serviceTotalCostSum`
FROM `human_view_service_queries`
WHERE (`human_view_service_queries`.`sbStatus` = 1)
GROUP BY `human_view_service_queries`.`IDc`;
...
AND (`clients`.`account_status` = 1));

--
-- Создать представление `human_view_total_cost`
--
CREATE
DEFINER = 'root'@'%'
VIEW human_view_total_cost
AS
SELECT
  `nearest_booking`.`IDc` AS `IDc`,
  `living_list`.`IDliv_l` AS `IDliv_l`,
...
--
-- Создать таблицу `total_bills`
--
CREATE TABLE total_bills (
  IDtb int(11) NOT NULL AUTO_INCREMENT,
  IDip int(11) NOT NULL COMMENT 'кто подтвердил оплату',
  IDliv_l int(11) NOT NULL,
  tbLivingCost double NOT NULL,
  tbLivingDaysCount int(11) NOT NULL,
  tbServiceCost double NOT NULL,
  tbTotalCost double NOT NULL DEFAULT 1,
  tbPayDate datetime NOT NULL,
  tbPayDateDay date NOT NULL,
  PRIMARY KEY (IDtb)
)
ENGINE = INNODB,
AUTO_INCREMENT = 15,
...
CHARACTER SET utf8,
COLLATE utf8_general_ci,
COMMENT = 'итоговые счета';

--
-- Создать внешний ключ
--
ALTER TABLE total_bills
ADD CONSTRAINT FK_total_bills_IDip FOREIGN KEY (IDip)
...
--
ALTER TABLE total_bills
ADD CONSTRAINT FK_total_bills_IDliv_l FOREIGN KEY (IDliv_l)
REFERENCES living_list (IDliv_l) ON UPDATE CASCADE;
...
FROM `total_bills`
WHERE (`total_bills`.`tbPayDateDay` BETWEEN CURDATE() AND CURDATE())
...
(53, '111358767', 'password_has_been_reset', '', 0),
(54, '847800547', 'password_has_been_reset', '', 0),
(55, '867414873', 'password_has_been_reset', '', 0),
(56, '940651760', 'password_has_been_reset', '', 0),
(57, '117807089', 'password_has_been_reset', '', 0),
(58, '107698072', 'password_has_been_reset', '', 0),
(59, '496268309', 'password_has_been_reset', '', 0);
...
(26, 3, 30, 15, '2019-11-13 02:31:15', '2020-01-12 17:24:14', 1),
(27, 6, 30, 3, '2019-11-13 02:31:15', '2019-11-15 18:50:14', 1),
(28, 7, 30, 2, '2019-11-13 02:31:15', '2019-11-15 18:50:14', 1),
(29, 10, 30, 1, '2019-11-13 02:31:15', '2019-11-15 18:49:05', 1),
(30, 11, 30, 1, '2019-11-13 02:31:15', '2019-11-15 18:50:14', 1),
(31, 15, 30, 1, '2019-11-13 02:31:15', '2020-01-12 17:24:33', 1),
(32, 1, 30, 1, '2019-11-13 02:31:45', '2019-11-15 18:43:51', 1),
(33, 4, 30, 1, '2019-11-13 02:31:45', '2019-11-14 20:53:30', 1),
(34, 6, 30, 1, '2019-11-13 02:31:45', '2019-11-15 18:48:20', 1),
(35, 9, 30, 1, '2019-11-13 02:31:45', '2019-11-14 20:53:30', 1),
(36, 10, 30, 1, '2019-11-13 02:31:45', '2019-11-15 18:18:28', 1),
(37, 12, 30, 1, '2019-11-13 02:31:45', '2019-11-14 20:55:37', 1),
(38, 11, 30, 1, '2019-11-13 02:31:45', '2019-11-14 20:53:30', 1),
(39, 13, 30, 1, '2019-11-13 02:31:45', '2019-11-15 18:46:18', 1),
(40, 14, 30, 1, '2019-11-13 02:31:45', '2020-01-12 17:24:14', 1),
(41, 6, 31, 19, '2020-01-11 20:29:44', '2020-01-11 20:30:05', 1),
(42, 14, 31, 8, '2020-01-11 20:29:44', '2020-01-11 20:30:05', 1),
(43, 12, 31, 5, '2020-01-11 20:29:44', '2020-01-11 20:30:05', 1),
(44, 1, 33, 5, '2020-02-06 19:51:35', '2020-02-06 19:51:47', 1);
...
(1, 'SERVER', '1', ''),
(2, 'dVmon', '88a4b282d4b2d31968490ed20d02b39a', '342cca881a10bd9e3f4a621038d39cc4');

-- 
-- Вывод данных для таблицы total_bills
--
INSERT INTO total_bills VALUES
(12, 2, 32, 420, 7, 0, 420, '2020-01-12 00:00:00', '2020-01-12'),
(13, 2, 31, 5310, 59, 197, 5507, '2020-02-06 20:05:09', '2020-02-06'),
(14, 2, 33, 1260, 14, 20, 1280, '2020-02-06 20:05:11', '2020-02-06');
...
(38, '2019-11-15 18:49:05', 'Предоставлена услуга с ID = 29', 2, 4),
(39, '2019-11-15 18:50:14', 'Предоставлена услуга с ID = 28', 2, 4),
(40, '2019-11-15 18:50:14', 'Предоставлена услуга с ID = 30', 2, 4),
(41, '2019-11-15 18:50:14', 'Предоставлена услуга с ID = 27', 2, 4),
(42, '2019-12-07 16:01:01', 'Сброшен бронь и аккаунт с ID = 53 по истечению срока брони', 1, 2),
(43, '2019-12-07 16:01:01', 'Сброшен бронь и аккаунт с ID = 54 по истечению срока брони', 1, 2),
(44, '2020-01-09 21:00:57', 'Подтверждено заселение клиента ID = 55 в комнату ID = 18', 2, 5),
(45, '2020-01-10 01:02:34', 'Подтверждено заселение клиента ID = 56 в комнату ID = 14', 2, 5),
(46, '2020-01-11 19:01:00', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(47, '2020-01-11 19:01:00', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(48, '2020-01-11 20:01:00', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(49, '2020-01-11 20:01:00', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(50, '2020-01-11 20:30:05', 'Предоставлена услуга ID = 41', 2, 4),
(51, '2020-01-11 20:30:05', 'Предоставлена услуга ID = 42', 2, 4),
(52, '2020-01-11 20:30:05', 'Предоставлена услуга ID = 43', 2, 4),
(53, '2020-01-11 21:01:01', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(54, '2020-01-11 21:01:01', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(55, '2020-01-11 22:01:01', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(56, '2020-01-11 22:01:01', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(57, '2020-01-11 23:01:01', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(58, '2020-01-11 23:01:01', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(59, '2020-01-11 23:39:58', 'Подтверждено заселение клиента ID = 58 в комнату ID = 13', 2, 5),
(60, '2020-01-12 00:01:01', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(61, '2020-01-12 00:01:01', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(62, '2020-01-12 17:24:14', 'Предоставлена услуга ID = 40', 2, 4),
(63, '2020-01-12 17:24:14', 'Предоставлена услуга ID = 26', 2, 4),
(64, '2020-01-12 17:24:33', 'Предоставлена услуга ID = 31', 2, 4),
(65, '2020-01-12 18:01:01', 'Сброшен бронь и аккаунт с ID = 56 по истечению срока брони', 1, 2),
(66, '2020-01-12 18:01:01', 'Сброшен бронь и аккаунт с ID = 57 по истечению срока брони', 1, 2),
(72, '2020-01-12 18:51:27', 'Сброшен бронь и аккаунт с ID = 58, оплата подтверждена', 2, 3),
(73, '2020-02-06 19:50:42', 'Подтверждено заселение клиента ID = 59 в комнату ID = 17', 2, 5),
(74, '2020-02-06 19:51:47', 'Предоставлена услуга ID = 44', 2, 4),
(75, '2020-02-06 20:05:09', 'Сброшен бронь и аккаунт с ID = 55, оплата подтверждена', 2, 3),
(76, '2020-02-06 20:05:11', 'Сброшен бронь и аккаунт с ID = 59, оплата подтверждена', 2, 3);
...
(23, 55, 'lol', '', '+7(684)465-78-57', 'pochta@pochta.pochta'),
(24, 56, 'twqt', '', '+7(244)141-24-14', 'das@s.r'),
(25, 57, 'dasd', '', '+7(241)242-14-12', 'dawsdwad'),
(26, 58, 'ads', '', '+7(241)241-44-44', '124124'),
(27, 59, 'DvMon', '', '+7(465)456-65-46', 'jkghukg76');
...
(51, 53, 14, '2019-11-07 16:29:43', '2019-11-08 00:00:00', '2019-11-23 00:00:00', 0),
(52, 54, 13, '2019-11-12 19:40:56', '2019-11-12 00:00:00', '2019-12-01 00:00:00', 0),
(53, 55, 18, '2020-01-09 20:59:55', '2020-01-09 00:00:00', '2020-03-08 00:00:00', 0),
(54, 56, 14, '2020-01-10 00:55:11', '2020-01-08 00:00:00', '2020-02-09 00:00:00', 0),
(55, 57, 7, '2020-01-10 02:04:29', '2020-01-08 00:00:00', '2020-01-17 00:00:00', 0),
(56, 58, 13, '2020-01-11 23:38:34', '2020-01-11 00:00:00', '2020-01-18 00:00:00', 0),
(57, 59, 17, '2020-02-06 19:49:41', '2020-02-06 00:00:00', '2020-02-20 00:00:00', 0);
...
FOR EACH ROW
BEGIN
  SET NEW.tbTotalCost = NEW.tbLivingCost + NEW.tbServiceCost;
  SET NEW.tbPayDate = NOW();
  SET NEW.tbPayDateDay = NOW();
END
$$
